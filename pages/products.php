...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="ms-auto d-none d-lg-block">
            <div class="input-group">
              ...
              <button class="btn text-white search">Search</button>
            </div>
          </div>
    ...
    <main class="pb-5 pt-5">
      <h2 class="text-center pb-3"><?php echo $_SESSION['category'] ?></h2>

      <div class="row p-5 w-100 cards-container">
        <?php
          $category = $_SESSION['category'];
          $selectProducts = "SELECT * FROM products WHERE category='$category' ORDER BY price DESC LIMIT 4";
          $products = $conn -> query($selectProducts);
          while($row = $products->fetch_assoc()) {
            echo '<div class="col-lg-3 col-md-6 pt-3 card-item">';
              echo '<div class="card">';
